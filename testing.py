...
if not df_stocks.empty:
    ...
    with tabs[7]:
        ...
        try:
            ...
            st.warning(f"Error loading Market News Endpoint: {str(e)}")
    ...
    with tabs[8]:
        ...
        try:
            fii_data = pd.read_excel(r'Stock-Screener073634.xlsx')
        ...
        try:
            bulk_data = pd.read_csv(r'Large-deals-BULK-23-Apr-2025.csv')
